...
inline int ConfigManager::getSaveInterval() const {
    return config_["io_manager"]["save_interval"].as<int>(1);
}

inline int ConfigManager::getSaveQuality() const {
    return config_["io_manager"]["save_quality"].as<int>(85);
}
